...
#ifndef STREAMVORTI_ELEMENTS_TETRAHEDRON_HPP_
#define STREAMVORTI_ELEMENTS_TETRAHEDRON_HPP_
...
private:
    ...
    StreamVorti::ElementType element_type_;     /*!< The element type of the tetrahedron is set during construction. */
};
...
#endif //STREAMVORTI_ELEMENTS_TETRAHEDRON_HPP_
