...
#ifndef STREAMVORTI_MESH_IO_ABAQUS_IO_TPP_
#define STREAMVORTI_MESH_IO_ABAQUS_IO_TPP_
...
void AbaqusIO::SaveMesh(const MESHTYPE &mesh, const std::string &mesh_filename)
{
    ...
    out << "*Heading\n";
    out << "** Job name: StreamVorti-mesh-job Model name: Model-1\n";
    out << "** Generated by: StreamVorti, echo=NO, model=NO, history=NO, contact=NO\n";
    out << "**\n";
    out << "** PARTS\n";
    out << "**\n";
    ...
    case StreamVorti::MeshType::tetrahedral :
...
#endif //STREAMVORTI_MESH_IO_ABAQUS_IO_TPP_
