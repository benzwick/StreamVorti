...
echo "Building StreamVorti with ECL + Gmsh support..."
...
# Configure StreamVorti with ECL and Gmsh
cmake \
  -DMFEM_DIR=${MFEM_DIR} \
  -DCMAKE_BUILD_TYPE=${BUILD_TYPE} \
  -DSTREAMVORTI_WITH_ECL=ON \
  -DSTREAMVORTI_WITH_GMSH=ON \
...
echo "StreamVorti with ECL + Gmsh built successfully"
