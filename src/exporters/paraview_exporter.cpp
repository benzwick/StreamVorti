...
//        std::string error = "[ExplicitSim Error] The size of the given vector field is different from the model's grid size.";
...
//        std::string error = "[ExplicitSim Error] Unknown XML file. Parent branch expected to be VTKFile.";
//        throw std::runtime_error(error.c_str());
//    }
...
//    if (piece == nullptr) {
//        std::string error = "[ExplicitSim Error] 'Piece' branch was not found. Expected XML tree is: VTKFile->UnstructuredGrid->Piece.";
//        throw std::runtime_error(error.c_str());
//    }
...
//        std::string error = "[ExplicitSim ERROR] Cannot generate ParaView animation file (.pvd). Expected path to an existing directory.";
//        throw std::invalid_argument(error.c_str());
//    }
...
//                std::string error = "[ExplicitSim ERROR] Cannot generate Paraview animation file (.pvd). Expected file format filenameXX.vtu."
