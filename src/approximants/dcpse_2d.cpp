...
Dcpse2d::Dcpse2d() : base_function_type_(""), exact_derivatives_(false)
{}
...
void Dcpse2d::SetBasisFunctionType(const std::string &basis_function_type)
{
...
void Dcpse2d::SetExactDerivativesMode(const bool &exact_derivatives)
{
...
void Dcpse2d::ComputeShFuncAndDerivs(const std::vector<Node> &geom_nodes,
